...
// Check if text "Edmonton" is matched with any of the text dislayed on the screen
...
// Click on Confirm
            ...
            onData(anything()).inAdapterView(withId(R.id.city_list))
                    .atPosition(0)
                    .perform(click());
            onView(withId(R.id.textViewCityName)).check(matches(isDisplayed()));
        }

        /**
         * Test 2: Test whether city name is consistent after switching.
         */
        @Test
